<%-- 
    Document   : doquiz
    Created on : Feb 19, 2021, 7:58:16 PM
    Author     : DELL INC
--%>
                ...
                <form action="takeQuizPrj" method="POST">
                    ...
                    <div class="row" style="margin: auto;">
                        ...
                        <div class="col-sm-6">
                            ...
                            <button id="finish" style="float: right;" name="btAction" value="finishQuiz" type="submit" class="btn btn-outline-success">Finished</button>
                        </div>
                    </div>
                </form>
