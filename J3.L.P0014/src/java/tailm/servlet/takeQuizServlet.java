...
import tailm.answer.AnswerDAO;
import tailm.answer.AnswerDTO;
import tailm.question.QuestionDAO;
import tailm.question.QuestionDTO;
import tailm.quiz.QuizDAO;
import tailm.quiz.QuizDTO;
import tailm.quizdetail.QuizDetailDAO;
import tailm.result.ResultDAO;
import tailm.result.ResultDTO;
...
public class takeQuizServlet extends HttpServlet {
    ...
    private final String LOAD_QUIZ_PRJ = "takeQuizPrj";
        ...
        try {
            ...
            if (listQuestionQuiz != null) {
                ...
                for (int i = 0; i < listQuestionQuiz.size(); i++) {
                    ...
                    quizDetailDAO.insertNewQuizDetails(quizID, listQuestionQuiz.get(i).getQuestionID(), listQuestionQuiz.get(i).getQuestionContent(), 0, "");
            ...
            RequestDispatcher rd = request.getRequestDispatcher(listFilter.get(LOAD_QUIZ_PRJ));
