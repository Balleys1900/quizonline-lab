 ...
 * @author DELL INC
 */
@WebServlet(name = "loadQuestionAdminServlet", urlPatterns = {"/loadQuestionAdminServlet"})
public class loadQuestionAdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.loadQuestionDefault(pageIndex);
            List<QuestionDTO> listQuestion = dao.getListQuestion();
            
            request.setAttribute("LISTQUESTION", listQuestion);
            request.setAttribute("ACTIONLOAD", "loadQuestionAdmin");
            request.setAttribute("TOTALPAGE", dao.countTotalPageDefault());
